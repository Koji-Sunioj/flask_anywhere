...
{   
    ...
    { 
        ...
        if ($('#variable_column[name=value]').val())
        {
    ...
    {   
        ...
        { 
         ...
         /*
        if ($('#variable_column[name=value]').val() === null) //| $('#variable_column[name=value]').val() === undefined
        {
                $('#send_values').prop('disabled',true)
        }
       
        else if (!String(x_selected).includes('Axis') && !String(y_selected).includes('Axis'))
        {
            $('#send_values').prop('disabled',false)
        }  */
    });
